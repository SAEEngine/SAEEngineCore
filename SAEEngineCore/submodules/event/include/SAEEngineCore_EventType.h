...
private:
  const static inline ::sae::unordered_dualmap<std::string, EVENT_TYPE_E>
      STR_ENUM_DMAP{
          {"NULL_EVENT", EVENT_TYPE_E::NULL_EVENT},
          ...
          {"GROW_EVENT", EVENT_TYPE_E::GROW_EVENT},
          {"REFRESH_EVENT", EVENT_TYPE_E::REFRESH_EVENT},
          {"WINDOW_CLOSE", EVENT_TYPE_E::WINDOW_CLOSE}};
  EVENT_TYPE_E val_;

public:
  friend constexpr inline bool
  operator==(const EVENT_TYPE &_lhs, const EVENT_TYPE &_rhs) noexcept = default;
  friend constexpr inline bool
  operator!=(const EVENT_TYPE &_lhs, const EVENT_TYPE &_rhs) noexcept = default;
  explicit operator bool() noexcept = delete;

  static inline std::optional<EVENT_TYPE_E>
  from_string(const std::string &_str) {
  ...
  constexpr inline operator EVENT_TYPE_E() const noexcept {
    return this->val_;
  };
  constexpr EVENT_TYPE(EVENT_TYPE_E _val) noexcept : val_{_val} {};
