...
bool GLFWLib::good() const noexcept { return this->good_; };
...
void GLFWLib::poll_events() { glfwPollEvents(); };

GLFWLib::GLFWLib() { this->init(); };
GLFWLib::~GLFWLib() { this->destroy(); };

} // namespace sae::engine::core

namespace sae::engine::core {

bool GLFWLib_Ref::good() const noexcept { return (bool)this->lib_; };
GLFWLib_Ref::operator bool() const noexcept { return this->good(); };
...
GLFWLib_Ref::reference GLFWLib_Ref::operator*() { return *this->get(); };
GLFWLib_Ref::const_reference GLFWLib_Ref::operator*() const {
  return *this->get();
};

GLFWLib_Ref::GLFWLib_Ref(std::shared_ptr<value_type> _lib) : lib_{_lib} {};
...
void Window::swap_buffers() { glfwSwapBuffers(this->get()); };

Window::Window(pointer _ptr) : ptr_{_ptr} {
