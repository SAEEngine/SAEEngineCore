...
bool ShaderProgram::good() const noexcept { return this->id() == 0; };

GLuint ShaderProgram::id() const noexcept { return this->id_; };
...
ShaderProgram::ShaderProgram(GLuint _id) : id_{_id} {};
...
std::optional<ShaderProgram> HACK_generate_shader(std::istream &_vertex,
                                                  std::istream &_fragment) {
  char _buff[256]{};
